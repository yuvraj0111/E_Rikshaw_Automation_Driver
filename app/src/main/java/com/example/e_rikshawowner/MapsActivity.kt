...
import com.example.e_rikshawowner.databinding.ActivityMapsBinding
import com.example.e_rikshawowner.receievenotifications.FirebaseService
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                if (locationResult.locations.isNotEmpty()) {
                    ...
                    databaseRef.child("DRIVERS").child(email).setValue(objOfLocationCordinates)
                    ...
                    if (location != null) {
                        ...
                        binding.doneButtonOnGoogleMap.setOnClickListener {
                            Toast.makeText(this@MapsActivity,"Done",Toast.LENGTH_SHORT).show()
